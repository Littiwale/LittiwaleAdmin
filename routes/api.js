    ...
    try {
        ...
        if (customerPhone && customerPhone.length >= 10) {
            ...
            try {
                ...
                console.warn('Customer auto-sync note:', custErr.message);
            }
        }
        ...
        // Note: Customer order confirmation email will be sent ONLY when Admin reviews & accepts the order in Admin Panel!
